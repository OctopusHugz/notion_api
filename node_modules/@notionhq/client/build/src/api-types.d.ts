...
export declare type Parent = DatabaseParent | PageParent | WorkspaceParent;
export declare type ParentInput = Omit<DatabaseParent, "type"> | Omit<PageParent, "type">;
...
export declare type InputPropertyValue = TitleInputPropertyValue | RichTextInputPropertyValue | NumberPropertyValue | SelectPropertyValue | MultiSelectPropertyValue | DatePropertyValue | FormulaPropertyValue | RollupPropertyValue | PeoplePropertyValue | FilesPropertyValue | CheckboxPropertyValue | URLPropertyValue | EmailPropertyValue | PhoneNumberPropertyValue | CreatedTimePropertyValue | CreatedByPropertyValue | LastEditedTimePropertyValue | LastEditedByPropertyValue;
